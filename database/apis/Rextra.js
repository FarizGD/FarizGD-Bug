...
return "愛FarizGD愛" + Math.random().toString(36).substring(7);
}
};
break;
case 'hard':
...
lock: { antiDebug: true },
identifierGenerator: function () {
return "神殺FarizGD暗黒神" + Math.random().toString(36).substring(7);
}
};
break;
case 'extreme':
...
identifierGenerator: () => {
return "影FarizGD零EXTREME影" + Math.random().toString(36).substring(2, 6);
}
};
break;
default:
