...
res.sendFile(path.join(__dirname, 'public/login/access.html'))});
//
...
res.sendFile(path.join(__dirname, 'public/docsmenu/apihelp.html'));
});
//
...
//============
console.log("FarizGD-Bug Started!")
app.listen(PORT, () => {
